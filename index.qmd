...
- About [12%]{.emph} of the human population is illiterate today [@unesco2025factsheet]
...
::: column
::: fragment
![](assets/bilingual-chart-without-US.png){width="100%"}
:::
:::

::: column
::: fragment
![](assets/bilingual-chart-with-US.png){width="100%"}
:::
:::
...
So we're right at the average percentage compared to the EU.
...
::: column
::: fragment
![](assets/number-of-bilinguals-without-US.png)
:::
:::

::: column
::: fragment
![](assets/number-of-bilinguals-with-US.png)
:::
:::
...
but we have a TON more speakers!
...
- In our part of the world, about 1 in 3 people are bilingual
- We see that in the US, bilingualism is particularly concentrated in specific areas
  - The New York/New Jersey areas is one!
- We want to [support]{.emph} our bilingual population by providing...
  - adequate [language access]{.emph} resources
  - adequate [education]{.emph}
...
- They [systematize]{.emph} and [classify]{.emph} language and language use:
...
We are often told that being bilingual is an [advantage]{.emph} in society

::: fragment
... but an advantage for who?
:::

::: fragment

@zavala2024ideology argue that bilingualism is not a neutral category, but [political]{.emph}
...
- In the United States, knowing an indigenous language like [Nahuatl]{.emph} has been seen as [useless]{.emph}

  - In many countries, indigenous languages are seen as [lesser]{.emph} because they do not have a standard grammar or a written form

- In Peru, "bilingual" is often used with [deficit connotations]{.emph} for Quechua-Spanish bilinguals

- In the Philippines, English-Filipino bilingualism [erased]{.emph} the presence of more than 100 local languages.
...
3. Bilingual children can't achieve/gain the same knowledge that monolingual children can.
4. Using two languages at once means you aren't proficient in either.
...
<center>
[FALSE]{.p-font style="font-size: 3em"}
</center>
...
- There is no strict separation between a bilingual's two languages in their brain
- It is like a spider web: when you touch a string, the whole web moves
...
- Semantic competitors:
  - carro, coche, automóvil, bus, taxi, Uber, Lyft, car, automobile, bus, taxi...

:::

::: fragment

- Phonetic competitors:
  - [ca]{.emph}rro, [ca]{.emph}r, [ca]{.emph}sa, [ca]{.emph}ja, [ca]{.emph}ma, [ca]{.emph}rton, [ca]{.emph}rver, [ca]{.emph}rgo...
...
- Children are evaluated in phases, typically on a standardized scale
  - e.g., by 2 years old, a child should produce at least 200 words
- [Problem]{.emph}: the same scale is normally used to evaluate these two different populations
...
- Bilingual children spread their knowledge [across two languages]{.emph}
  - They know 200 total words, but only 100 in English
  - They know how to count in English, but not in Spanish
- This leads to [over-diagnosis]{.emph} of developmental delays, when really they may just need a bit more language support at school!

:::

## Using two languages at once means you aren't proficient in either.
...
- Switching between two languages in a conversation requires [proficiency]{.emph} in both languages [@gumperz1999codeswitching]

:::

## Using two languages at once means you aren't proficient in either.

- Bilingual children know what language to speak with who [@harrison1980young]
- Mixing languages is not a sign of confusion or laziness
- There are [rules]{.emph} to mixing languages -- it's not random, and the child knows them!
- We call this language-mixing [codeswitching]{.emph}
...
Rate these sentences on a scale of 1 (very unnatural) to 5 (very natural):

- Can you peinarme?
- Fui a the tienda.
- Busco for a pair of shoes.
...
![](assets/spanglish1.png){width="60%"}

![](assets/spanglish2.png){width="60%"}

:::

::: {.column width="50%"}

![](assets/spanglish3.png){width="70%"}

![](assets/spanglish4.png){width="60%"}
...
Say the color of the [ink]{.emph}. Do not read the text.
...
<center>
[Ready?]{.p-font style="font-size: 5em"}
</center>
...
<center>
[brown]{.p-font style="color: red; font-size: 5em"}
</center>
...
<center>
[yellow]{.p-font style="color: blue; font-size: 5em"}
</center>
...
<center>
[red]{.p-font style="color: yellow; font-size: 5em"}
</center>
...
<center>
[brown]{.p-font style="color: green; font-size: 5em"}
</center>
...
<center>
[pink]{.p-font style="color: black; font-size: 5em"}
</center>
...
<center>
[green]{.p-font style="color: orange; font-size: 5em"}
</center>

## The Stroop Test

We use this task to test [executive function]{.emph}, which involves...
...
switching between tasks/perspectives.

:::

## Executive Function in Bilinguals

- It's been found that bilinguals have greater [executive function]{.emph} compared to monolinguals [@coderre2014electrophysiological]

::: incremental

- This means that bilinguals tend to...
  - have better impulse control
  - hold more information in their mind in the short-term
  - have greater ease switching between tasks

:::

## What if my child has Autism or ADHD?

- Some parents are concerned that hearing or speaking more than one language may [confuse]{.emph} a child
...
- For a long time, being bilingual was seen as a [disadvantage]{.emph}
- Parents were told to speak [only English]{.emph} at home, and many teachers still suggest this!
- This is especially the case for parents of children with autism or ADHD

:::

## Bilingualism and ADHD

- People diagnosed with attention deficit disorders tend to have [poorer]{.emph} executive function
- However, bilingualism seems to [mitigate]{.emph} the impact when under cognitive duress [@brouillardchallenges]

## Bilingualism and Autism

::: incremental

- [Autism]{.emph} is an umbrella term for a spectrum of differences from the [neurotypical]{.emph} population
- A typical fear is that a child with autism will be burdened by hearing and speaking two languages
- However, we have evidence in the contrary!
  - Bilingual children with autism do not show any delays greater than their monolingual counterparts
  - In fact, children with autism from a bilingual environment who are raised as monolingual show detrimental effects!
  
:::
  
::: footer
@beauchamp2017bilingualism
:::

## Bilingualism and the Brain

- Bilingualism makes your brain healthier!
- There is strong evidence that bilinguals retain [more brain matter]{.emph} as they grow older compared to monolinguals [@heim2019bilingualism]
- There is also evidence that bilingualism [delays the onset of Alzheimer's disease]{.emph}! [@woumans2015bilingualism]

## In sum...

::: incremental

- Bilingualism does not delay development in typical or atypical populations
- It is [healthy]{.emph} for the brain and provides certain [advantage]{.emph}

- Provides greater [executive function]{.emph}
...
::: notes
Do activities with your family. Language is social.
